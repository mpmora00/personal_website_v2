...
export const CodeProjectsList: Project[] = [
    {
        ...
        shortDescription: "(Personal)\nI taught myself HTML, JavaScript, and CSS to build this personal website showcasing my projects and skills.",
    ...
    },
    {
        ...
        shortDescription: "(Professional)\nHelped design and implement databases for the secure storage of both PHI (Protected Health Information) and non-PHI data.",
    ...
    },
    {
        ...
        shortDescription: "(Personal)\nAn upgrade to my personal website built with React and TypeScript to showcase my projects and skills.",
    ...
    },
    {
        ...
        language: "C",
        shortDescription: "(Academic)\nA command-line search program that allows users to search a website using specific words or keyword patterns, returning ranked results based on word frequency.",
    ...
    },
    {
        ...
        language: "C++",
        shortDescription: "(Academic)\nThis library solves matrix-based problems and was used to develop a machine learning algorithm that accurately recognizes hand-drawn numbers with 75% accuracy.",
    ...
    },
    {
        title: "Sudoku Solver",
        language: "C",
        shortDescription: "(Academic)\nThis module is capable of solving any sudoku puzzling using an efficient recursive algorithm.",
    ...
    },
    {
        ...
        language: "Java",
        shortDescription: "(Academic)\nUsed to practice the Point Quadtree Algorithm with a dot tree image but we enhanced it to accurately represent a whack-a-mole game interface.",
    ...
    },
    {
        ...
        language: "Java",
        shortDescription: "(Academic)\nOriginally implements a multi-threaded application for collaborative drawing but it evolved into a multiplayer game inspired by 'Draw Something'.",
    ...
    },
    {
        ...
        language: "Java",
        shortDescription: "(Academic)\nThis command-line part-of-speech tagger labels words, achieving a 97% accuracy rate when tested on a 10,000-word file.",
